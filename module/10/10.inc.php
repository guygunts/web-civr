...
//   PrintR($params);
    ...
    $url = URL_API . '/geniespeech/grammarlist';
...
//    exit;
    ...
    $url = URL_API . '/geniespeech/adddeleteupdategrammar';
    $response = curlposttoken($url, $params, $token);
    ...
    if ($response['code'] == 200) {
      ...
      'activity' => "Add Grammar Management"
      );
...
function Edit(Request $request)
{
    ...
    if ($response['code'] == 200) {
      ...
      'browser' => $_SERVER['HTTP_USER_AGENT'],
      'ip_address' => $_SERVER['REMOTE_ADDR'],
      'activity' => "Edit Grammar Management"
      );
	  $url1 = URL_API.'/geniespeech/loginsert';
$response1 = curlpost($url1, $params1);
        $result['success'] = 'COMPLETE';
...
function Del(Request $request)
{
    ...
    if ($response['code'] == 200) {
      ...
      'browser' => $_SERVER['HTTP_USER_AGENT'],
      'ip_address' => $_SERVER['REMOTE_ADDR'],
      'activity' => "Delete Grammar Management"
      );
	  $url1 = URL_API.'/geniespeech/loginsert';
$response1 = curlpost($url1, $params1);
        $result['success'] = 'COMPLETE';
