				 ...
				 Add
                         ...
                         <!--   <div class="form-group">
							...
							<div class="form-group">
							 ...
							 <div class="form-group">
                                <input class="form-control searchdata"  id="Package_Sub_Code_search" name="Package_Sub_Code_search" placeholder="Package_Sub_Code">
                            </div>
                            <div class="form-group">
...
<div class="row">
	...
	<div class="row">
        ...
        <div class="row">
		  ...
		  <div class="col-4 col-sm-8">
            <input id="productId" type="text" name="productId" class="col-4 col-sm-10" >
          </div>
        </div>
      </div>
	</div>
	...
	<div class="row">
        ...
        <div class="row">
		  ...
		  <div class="col-4 col-sm-8">
            <input id="productSequenceId" type="text" name="productSequenceId" class="col-4 col-sm-10" >
          </div>
        </div>
      </div>
	</div>
