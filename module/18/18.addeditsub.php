                            ...
                            <div class="form-group">
                                <label>
                                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input
                                            ...
                                            class="sub sub_<?php echo $value['sub_menu_id']?>_<?php echo $item['menu_id']?> main<?php echo $item['menu_id'] ?> menu_<?php echo $item['menu_id'] ?>_<?php echo $value['sub_menu_id'] ?>" type="checkbox"
