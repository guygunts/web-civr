...
var DateTimePicker = function ($, moment) {
    ...
    var DateTimePicker = function () {
        ...
        DateTimePicker.prototype._dataToOptions = function _dataToOptions() {
            ...
            $.each(this._options, function (k) {
                var attributeName = 'date' + k.charAt(0).toUpperCase() + k.slice(1); //todo data api key
                if (eData[attributeName] !== undefined) {
                    dataOptions[k] = eData[attributeName];
                } else {
                    delete dataOptions[k];
                }
            });
            return dataOptions;
        };
        ...
        DateTimePicker.prototype.options = function options(newOptions) {
            ...
            var self = this;
            $.each(this._options, function (k, value) {
                if (self[k] !== undefined) {
                    self[k](value);
                }
            });
